...
class CustomerDelete extends Component {
    ...
    deleteUser = async () => {
        ...
        try{
            ...
            if(result.message){
                ...
                this.setState({id:'',name:'',phoneNumber:'',address:'',borrowedMoney:'',borrowedType:'',typeOfRepayment:'',modeOfRepayment:'',installments:'',deadTime:''})
            }
        }catch(error){
            alert(error);
        }
    ...
    render() {
        const { id,name, phoneNumber, address,borrowedMoney,borrowedType,typeOfRepayment,modeOfRepayment,installments,deadTime  } = this.state;
        ...
        return (
            <div className="first-container">
                ...
                <button type="button" className='submit-button-update'onClick={this.deleteUser}>Delete User</button>
            </div>
        )
    }
}
